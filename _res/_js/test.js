!function(n) {
    ...
    if (n("#side-menu").metisMenu(),
    n("#vertical-menu-btn").on("click", function(e) {
        e.preventDefault(),
        n("body").toggleClass("sidebar-enable"),
        992 <= n(window).width() ? n("body").toggleClass("vertical-collapsed") : n("body").removeClass("vertical-collapsed")
    }),
    ...
    window.sessionStorage && ((r = sessionStorage.getItem("is_visited")) ? (n(".right-bar input:checkbox").prop("checked", !1),
    n("#" + r).prop("checked", !0),
    t(r)) : sessionStorage.setItem("is_visited", "light-mode-switch")),
